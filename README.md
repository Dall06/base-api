...
Copia de forma recursiva toda la arquitectura limpia de `base-api` a un nuevo directorio, renombrando todos los imports del módulo de Go al path de tu elección:
