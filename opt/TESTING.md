...
**Ejecutar**:
```bash
cd /Users/diegoa.leon/Documents/dev/bro/base-api/opt/db
...
**Ejecutar**:
```bash
cd /Users/diegoa.leon/Documents/dev/bro/base-api/opt/middlewares
...
**Ejecutar**:
```bash
cd /Users/diegoa.leon/Documents/dev/bro/base-api/opt/router
...
```bash
cd /Users/diegoa.leon/Documents/dev/bro/base-api/opt
go test -v ./...
```
